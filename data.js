/* =========================================================================
   ...
   - 이 파일에는 학사일정 달력 데이터만 둡니다:
       ...
       examSchedules: 고사 시간표 (달력에는 넣지 않고 시간표 표로만 표시)
...
/* 고사 시간표 — 달력과 별개로 표로만 보여준다.
   학생 알림장은 2학년 열만 '학급 시간표' 위에, 개인 알림장은 전 학년을 '시정표' 아래에 표시한다.
   grades는 [1학년, 2학년, 3학년] 순서, 시험이 없으면 ''. 마지막 날(end)이 지나면 자동으로 숨긴다. */
const examSchedules = [
  {
    title:'2학기 중간고사', start:'2026-10-13', end:'2026-10-16',
    days:[
      {date:'2026-10-13', slots:[
        {start:'08:30', end:'09:20', grades:['공통수학2', '미적분Ⅰ', '생태와 환경']},
        {start:'09:50', end:'10:40', grades:['한국사2', '현대사회와 윤리', '한국지리']},
        {start:'11:10', end:'12:00', grades:['', '역학과 에너지', '미적분']},
      ]},
      {date:'2026-10-14', slots:[
        {start:'08:30', end:'09:20', grades:['공통영어2', '화법과 언어', '독서']},
        {start:'09:50', end:'10:40', grades:['통합과학2', '기하', '사회·문화']},
        {start:'11:10', end:'12:00', grades:['', '세계사', '물리학Ⅱ']},
      ]},
      {date:'2026-10-15', slots:[
        {start:'08:30', end:'09:20', grades:['통합사회2', '영어Ⅱ', '심화국어']},
        {start:'09:50', end:'10:40', grades:['', '물질과 에너지, 정치', '생활과 윤리']},
        {start:'11:10', end:'12:00', grades:['', '', '기하']},
      ]},
      {date:'2026-10-16', slots:[
        {start:'08:30', end:'09:20', grades:['공통국어2', '사회와 문화', '영어독해와 작문']},
        {start:'09:50', end:'10:40', grades:['', '세포와 물질대사', '동아시아사, 화학Ⅱ']},
      ]},
    ],
  },
];
